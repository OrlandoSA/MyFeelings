package orlando.salazar.myfeelings.utilities

import android.content.Context
import android.graphics.*
import android.graphics.drawable.Drawable
import androidx.core.content.ContextCompat
import orlando.salazar.myfeelings.R

class CustomCircleDrawable: Drawable {
    var coordenadas: RectF?=null
    var angulosBarrido: Float=0.0F
    var angulosInicio: Float=0.0F
    ...
    override fun draw(p0: Canvas) {
        ...
        if(emociones.size !=0){
            for(e in emociones){
                ...
                p0.drawArc(coordenadas!!,this.angulosInicio,this.angulosBarrido, false, seccion)
                this.angulosInicio+=angulosBarrido
